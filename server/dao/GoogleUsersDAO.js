...
var TABLENAME = 'googleusers',
	...
	TOOLKIT_FOLDER_ID = "toolkitfolder";
...
GoogleUsersDAO.prototype.insertNewUsers = function(users,callback){
	...
	var newUserDetails = {
		...
		{name:LAST_VISIT,type:'BIGINT'},{name:TOOLKIT_FOLDER_ID,type:'string'}],
		values:userExtracts
	};
...
GoogleUsersDAO.prototype.getAllUsers = function(callback){
	var selectUsersDetails = {
		name:TABLENAME,
		distinct:false,
		attributes:[ID,GOOGLE_ID,TOKEN,EMAIL,LAST_VISIT,TOOLKIT_FOLDER_ID]
	};
